...
public class MainActivity extends net.techiebits.locationutilsapp.BaseLocationActivity
        implements OnMapReadyCallback, net.techiebits.locationutilsapp.BaseLocationActivity.onLocationConnected {
    ...
    /**
     *
     * @param location Firstly, it's the last known location then it's received from the locationUpdates
     */
    @Override
